...
function SportDoctorForm({ isEditMode = false, dataSportDoctor = {} }) {
    ...
    return (
        ...
        <div class="container px-6 py-8 mx-auto w-180">
            <h3 class="text-3xl font-semibold text-gray-900">{isEditMode ? "Modifica Medico Sportivo" : "Aggiungi Medico Sportivo"}</h3>
                ...
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                    <div
                        ...
                        <form id="sport-doctors-form" onSubmit={handleSubmit}>
                            <div id="sport-doctors-container" className='border border-gray-300 p-4 rounded-md bg-[rgb(20,30,37)]'>
                                <div class="sport-doctors-group">
                                    <label className='block text-white font-bold mb-3'>Nome</label>
                                    <input type="text" name="first_name" value={sportDoctor.first_name}
                                    ...
                                    <input type="text" name="last_name" value={sportDoctor.last_name}
                                        className="w-full px-4 py-2 mb-12 border border-gray-500 rounded-md
                                                  bg-gray-300 text-gray-900 focus:ring focus:ring-blue-500 focus:border-blue-500 focus:bg-amber-100"
                                        onChange={handleChange} required />

                                    <label className='block text-white font-bold mb-3' for="vat_number">Partita Iva</label>
                                    <input type="text" id="vat_number" name="vat_number" value={sportDoctor.vat_number}
                                        className="w-full px-4 py-2 mb-12 border border-gray-500 rounded-md
                                                  bg-gray-300 text-gray-900 focus:ring focus:ring-blue-500 focus:border-blue-500 focus:bg-amber-100"
