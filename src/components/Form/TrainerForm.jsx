                ...
                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                    <div
                        ...
                        <form id="trainers-form" onSubmit={handleSubmit}>
                            <div id="trainers-container" className='border border-gray-300 p-4 rounded-md bg-[rgb(20,30,37)]'>
                                <div class="trainers-group">

                                    <label className='block text-white font-bold mb-3' for="first_name">Nome</label>
                                    <input type="text" id="first_name" name="first_name" value={trainer.first_name}
                                    ...
                                    <label className='block text-white font-bold mb-3' for="last_name">Cognome</label>
                                    <input type="text" id="last_name" name="last_name" value={trainer.last_name}
                                        className="w-full px-4 py-2 mb-12 border border-gray-500 rounded-md
                                                  bg-gray-300 text-gray-900 focus:ring focus:ring-blue-500 focus:border-blue-500 focus:bg-amber-100"
                                        onChange={handleChange} required />

                                    <label className='block text-white font-bold mb-3' for="fiscal_code">Codice fiscale</label>
                                    <input type="text" id="fiscal_code" name="fiscal_code" value={trainer.fiscal_code}
                                        className="w-full px-4 py-2 mb-12 border border-gray-500 rounded-md
                                                  bg-gray-300 text-gray-900 focus:ring focus:ring-blue-500 focus:border-blue-500 focus:bg-amber-100"
